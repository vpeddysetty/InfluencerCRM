...
await renderCheck({
  ...
  pages: [
    { name: 'CouponsPage', path: '/src/CouponsPage.jsx' },
    { name: 'MarketplacePage', path: '/src/MarketplacePage.jsx' },
    { name: 'DashboardPage', path: '/src/DashboardPage.jsx' },
    { name: 'PortfolioPage', path: '/src/PortfolioPage.jsx' },
  ],
})
