...
import com.influencer.webe.shared.application.TokenVerifier;
 ...
 */
@Service
public class SessionService implements TokenVerifier {
    ...
    /**
     * {@link TokenVerifier} implementation, so shared code can authenticate a request without
     * depending on the Identity context.
     */
    @Override
    public Optional<TenantContext> verify(String accessToken) {
        return resolveTenantContext(accessToken);
    }
