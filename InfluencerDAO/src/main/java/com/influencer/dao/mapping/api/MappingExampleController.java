package com.influencer.dao.mapping.api;

import com.influencer.dao.mapping.domain.MappingExample;
import com.influencer.dao.mapping.infrastructure.MappingExampleRepository;
...
public class MappingExampleController {
    ...
    public MappingExample update(@PathVariable UUID id, @RequestBody MappingExample mappingExample) {
        ...
        existing.setBrandId(mappingExample.getBrandId());
