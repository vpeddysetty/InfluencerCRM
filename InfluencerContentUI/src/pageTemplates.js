 ...
 *
 * <p>THIS IS A COPY. The original is `InfluencerUI/src/shell/pageTemplates.js`; this duplicate
 ...
 * actually loads is this one.
 *
 * <p>`InfluencerUI/src/shell/remoteCopies.test.mjs` compares the two below their headers and
 * fails when they drift. Copy the change across; do not relax the assertion.
 */
