...
// `../../provenance`, not `../../shell/provenance` as in the gateway: this remote has no shell/.
// Copy of InfluencerUI/src/components/ui/MetricsProvenance.jsx — see the note in provenance.js.
import { describeProvenance, formatFetchedAt, isPlatformVerified } from '../../provenance'
